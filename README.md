...
<details><summary>Luaをマクロ言語として組み込み</summary><img src="https://raw.github.com/wiki/silica33/sakura/images/sakura_201706041845.png" width="50%"></details>  
<details><summary>スクロールバーに検索結果やブックマークを表示</summary><img src="https://raw.github.com/wiki/silica33/sakura/images/sakura_201706092354.png" width="50%"></details>  
<details><summary>Grepフォルダの指定を４つに拡張</summary><img src="https://raw.github.com/wiki/silica33/sakura/images/sakura_201706041815.png" width="50%"></details>  
...
変更内容はコミットログを参照してください. 細かい内容は [my_config.h](https://github.com/silica33/sakura/raw/master/sakura_core/my_config.h) を見てね.  

+ [sakura-silica-2.32-x86.zip](http://mimix.sakura.ne.jp/release/sakura-silica-2.32-x86.zip) (909KB)  
+ 最新のキーワードセット [keyword_pack.zip](https://github.com/silica33/sakura/raw/master/Publish/keyword_pack.zip) (355KB)  
...
Build environment  
-----------------
+ 2.2.0.1をベースに[リポジトリ](http://svn.code.sf.net/p/sakura-editor/code/sakura/trunk2)の追っかけ. ベースリビジョンからのマージ情報は[こちら](https://github.com/silica33/sakura/raw/master/Publish/changes_from_r4011.txt). あと、[パッチ](https://sourceforge.net/p/sakura-editor/patchunicode/)のマージ  
+ MSVC2017でビルド  
+ Boostを使用 (JSON)  
+ Luaを使用 (マクロ, プラグイン)  
...
|折り返しモードをトグルで切り替えたときに「折り返さない」が処理されていないのを修正:bug:|「指定桁で折り返す」のままになる|
|行番号縦線を行番号の色で描画する:bug:|行番号縦線はその行に変更があった場合, その行だけ変更色で縦線が引かれてしまう|
|行番号が非表示でブックマークが表示のときブックマークは線で描画するように修正:bug:|行番号非表示時のブックマーク表示がな|
