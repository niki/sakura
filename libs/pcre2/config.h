...
/* 20260720 サクラエディタ側での変更点:
   PCRE2 10.47のsrc/config.h.genericをリネームして同梱し、
...
/* 20260720 サクラエディタのフォールバック正規表現エンジンではwchar_t(UTF-16)を
   そのまま扱う16bit版のみを使うため有効化する。ビルドは
   sakura.vcxprojのCPreprocessorDefinitionsでもPCRE2_CODE_UNIT_WIDTH=16を指定する。 */
...
/* 20260720 bregonig.dll(Oniguruma系)同様、\w等をUnicode基準にするため有効化 */
