...
EFunctionCode CKeyBind::GetDefFuncCode( int nKeyCode, int nState )
{
	...
	if( nKeyCode == VK_F4 ){
		if( nState == _CTRL ){
			nDefFuncCode = F_FILECLOSE;	// 閉じて(新規)
...
//	Ctrl+F4に割り当てられていた「縦横に分割」を「閉じて(新規)」に変更し Shift+Ctrl+F4 に「閉じて開く」を追加
...
#define _MOVE_LINE_UP		F_MOVE_LINE_UP		// 20260823
#define _MOVE_LINE_DOWN		F_MOVE_LINE_DOWN	// 20260823
#else
#define _MOVE_LINE_UP		F_0
#define _MOVE_LINE_DOWN		F_0
#endif // NKMM_
...
//		0,		1,		 2(000), 3(001),4(010),	5(011),		6(100),	7(101),		8(110),		9(111)
	...
	{ VKEX_DBL_CLICK,	(LPCTSTR)STR_KEY_BIND_DBL_CLICK,	{ F_SELECTWORD,		F_0,		F_0,			F_0,		F_0,			F_0,		F_0,			F_0 }, }, //Feb. 19, 2001 JEPRO Altと右クリックの組合せは効かないので右クリックメニューのキー割り当てをはずした
	{ VKEX_R_CLICK,		(LPCTSTR)STR_KEY_BIND_R_CLICK,		{ F_MENU_RBUTTON,	F_0,		F_0,			F_0,		F_0,					F_0,				F_0,					F_0 }, },
	...
	{ VK_F5,	_T("F5" ),			{ F_SHOWUNDOHISTORYPANEL,F_REDRAW,			F_EXECMD_DIALOG,		F_0,				F_UUDECODE,				F_0,				F_TABTOSPACE,			F_SPACETOTAB }, },
	...
	{ VK_RETURN,_T("Enter"),		{ F_0,				F_0,				F_0,				F_0,				F_PROPERTY_FILE,		F_0,				F_0,					F_0 }, },
	...
	// Ctrl+Alt+↑は元々F_UP2_BOX(矩形選択カーソル上移動、2行ごと)だったが、マルチカーソルの
	// 「カーソルを上に追加」(F_ADD_CURSOR_UP)へ差し替えた(VS Code等に合わせた配置)。
	// F_UP2_BOXは既定キー無しになる(矩形選択自体はAlt+↑等で開始でき、2行ジャンプは
	// Alt+↑の複数回押しで代替できるため実害は小さいと判断。手動での再割り当ては引き続き可能) 20260830
	{ VK_UP,	_T("↑"),			{ F_UP,				F_UP_SEL,			F_WndScrollDown,		F_MOVE_LINE_UP,			F_UP_BOX,				F_0,		F_ADD_CURSOR_UP,		F_MAXIMIZE_V },},
#else
...
#ifdef NKMM_MULTI_CURSOR
	// Ctrl+Alt+↓も同様にF_DOWN2_BOXからF_ADD_CURSOR_DOWNへ差し替え 20260830
	{ VK_DOWN,	_T("↓"),			{ F_DOWN,			F_DOWN_SEL,			F_WndScrollUp,			F_MOVE_LINE_DOWN,		F_DOWN_BOX,				F_0,	F_ADD_CURSOR_DOWN,		F_MINIMIZE_ALL },},
#else
	...
	{ 'N',		_T("N"),			{ F_0,				F_0,				F_FILENEW,				F_0,				F_0,		F_0,				F_0,					F_0 }, },
	{ 'O',		_T("O"),			{ F_0,				F_0,				F_FILEOPEN,				F_0,				F_OPEN_HfromtoC,					F_0,				F_0,					F_0 }, },
#ifdef NKMM_COMMAND_PALETTE
	// Shift+Ctrl+Pは元々F_PRINT_PREVIEW(印刷プレビュー)だったが、コマンドパレットへ
	// 差し替えた(VSCode等に合わせた配置)。印刷プレビューは既定ショートカットなしになる 20260818
	{ 'P',		_T("P"),			{ F_0,				F_0,				F_PRINT,				F_COMMAND_PALETTE,	F_0,		F_0,				F_PRINT_PAGESETUP,		F_0 }, },
#else
	{ 'P',		_T("P"),			{ F_0,				F_0,				F_PRINT,				F_PRINT_PREVIEW,	F_0,		F_0,				F_PRINT_PAGESETUP,		F_0 }, },
#endif // NKMM_
	{ 'Q',		_T("Q"),			{ F_0,				F_0,				F_CREATEKEYBINDLIST,	F_0,				F_0,					F_0,				F_0,					F_0 }, },
	{ 'R',		_T("R"),			{ F_0,				F_0,				F_OUTLINE,		F_0,				F_RTRIM,				F_0,				F_0,					F_0 }, },
...
#ifdef NKMM_MULTI_CURSOR
	// Ctrl+Shift+Uに、直近のカーソル追加操作を1つ取り消す機能(VS CodeのCtrl+U相当)を割り当てる 20260830
	{ 'U',		_T("U"),			{ F_0,				F_0,				F_LineDeleteToStart,		F_MULTICURSOR_UNDO,F_0,				F_0,				F_WRAPWINDOWWIDTH,		F_0 }, },
#else
	{ 'U',		_T("U"),			{ F_0,				F_0,				F_LineDeleteToStart,		F_0,F_0,					F_0,				F_WRAPWINDOWWIDTH,		F_0 }, },
#endif // NKMM_
	{ 'V',		_T("V"),			{ F_0,				F_0,				F_PASTE,				F_0,				F_0,					F_0,				F_0,					F_0 }, },
	{ 'W',		_T("W"),			{ F_0,				F_0,				F_0,			F_0,				F_0,					F_0,				F_TMPWRAPWINDOW,		F_0 }, },
