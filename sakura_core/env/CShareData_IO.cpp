...
#if SI_DELETE_HISTORY_NOT_EXIST_AT_STARTUP
				if (!!RegKey(SI_REGKEY).get(_T("DeleteHistoryNotExistAtStartup"), 1)) {
...
{
#ifdef SI_FIX_MAINMENU_FORCE_DEFAULT
