...
/*  5 */		F_FILECLOSE					/* , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0 */,	//閉じて(新規)	//Oct. 17, 2000 jepro 「ファイルを閉じる」というキャプションを変更
...
/* 219 */		F_DISABLE				/* , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0 */,	//ダミー(旧ミニマップ表示)
