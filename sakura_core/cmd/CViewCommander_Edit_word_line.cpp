...
//!   置き換える。どちらかの行が空/空白のみの場合は、余計なスペースを入れずに詰める
//! - 選択が複数行にまたがらない場合(選択なし、または選択が1行内に収まっている場合)は、
//!   カーソル行と次の行を結合する(VS Code/Sublime Textの既定動作相当)
//! - 矩形選択中、または結合先の次の行が無い(カーソル/選択が最終行にある)場合は何もしない
