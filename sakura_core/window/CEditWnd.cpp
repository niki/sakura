...
//	変数削除
	...
	if( NULL != m_cStatusBar.GetStatusHwnd() ){
		...
		const TCHAR*	pszLabel[nStArrNum] = { _T(""), _T("Ln 99999 Col 999"), _T("U+AAAAAAAA"), _T("UTF-16 BOM"), _T("Unix"), _T("INS"), _T("Spaces: 9"), _T("AAAAAAAAAAAA"), _T("●") };
	#else
		const TCHAR*	pszLabel[nStArrNum] = { _T(""), _T("Ln 99999 Col 999"), _T("U+AAAAAAAA"), _T("UTF-16 BOM"), _T("Unix"), _T("上書"), _T("Spaces: 9"), _T("AAAAAAAAAAAA"), _T("●") };
	#endif
#else
