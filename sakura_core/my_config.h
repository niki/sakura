...
// 拡張用レジストリキー
#define CL_REGKEY _T("Software\\sakura-calette")
...
//------------------------------------------------------------------
#define CL_MOD_CENTERING_CURSOR_JUMP

//------------------------------------------------------------------
// タブ入力文字の切り替え(タブ<->空白)を追加
//  - S_ChangeTabWidthマクロ修正, 負の値を渡すとタブ文字の切り替え
//------------------------------------------------------------------
#define CL_MOD_CHANGE_TAB_WIDTH_MACRO
...
//  - .rcファイルは数が多いので置換対応
//------------------------------------------------------------------
#define CL_MOD_UI_FONT

//------------------------------------------------------------------
// 'BOM付' を 'BOM' に変更 2017.4.17
//  - わざわざ「付」をつけなくても認識できると判断とスペースの節約
//------------------------------------------------------------------
#define CL_MOD_WITH_BOM_TEXT

//------------------------------------------------------------------
// タブ名カラーの変更
//------------------------------------------------------------------
#define CL_MOD_TAB_CAPTION_COLOR
  // 変更ドキュメントタブ名カラー
  // (REG/TabCaptionModifiedColor:0x00BBGGRR)
  #define CL_MOD_MODIFIED_TAB_CAPTION_COLOR (0x00d70000)
  // マクロ記録中ドキュメントタブ名カラー
  // (REG/TabCaptionRecMacroColor:0x00BBGGRR)
  #define CL_MOD_RECMACRO_TAB_CAPTION_COLOR (0x000000d8)
...
//  x キャレットを行間含む高さにする
//------------------------------------------------------------------
#define CL_LINE_CENTERING

//------------------------------------------------------------------
// EOFのみの行にも行番号を表示 2017.3.10
//------------------------------------------------------------------
#define CL_MOD_EOFLN_DISP_NR
...
// (REG/CaretType:2)
//------------------------------------------------------------------
#define CL_MOD_CARET (2)

//------------------------------------------------------------------
// 半角空白文字を "・" で描画 2013.6.2
//------------------------------------------------------------------
#define CL_MOD_HAN_SPACE

//------------------------------------------------------------------
// Non-Breaking-Spaceを半角空白として表示する 2017.4.15
//------------------------------------------------------------------
#define CL_MOD_NBSP_DISP
...
//------------------------------------------------------------------
#define CL_MOD_TAB_MARK

//------------------------------------------------------------------
// カーソル行アンダーライン
//  - 左端から 2015.1.30
//------------------------------------------------------------------
#define CL_MOD_CUR_UL
...
#define CL_MOD_SELAREA
  ...
  #define CL_MOD_SELAREA_BACK_BLEND_PER2 (60)  // 特定の下地のときの選択範囲のブレンド率
...
//  - 折り返し記号 テキストカラーのみ
//------------------------------------------------------------------
#define CL_MOD_COLOR_STRATEGY

//------------------------------------------------------------------
// コメント行の修正 2016.12.27
// 0x01: 改行以降もカラーを有効にする
//------------------------------------------------------------------
#define CL_MOD_COMMENT

//------------------------------------------------------------------
// 数値の色付け判定の修正
//  - 正規表現で判定する 2017.4.21
//------------------------------------------------------------------
#define CL_MOD_NUMERIC_COLOR
...
//------------------------------------------------------------------
#define CL_MOD_SEARCH_KEY_REGEXP_AUTO_QUOTE

//------------------------------------------------------------------
// 正規表現検索のときに「単語単位で探す」を使用できるようにする 2017.4.27
//  - チェック時に検索文字列を \b で囲む (未実装)
//------------------------------------------------------------------
//#define CL_MOD_ENABLE_WORD_SEARCH_REGEXP
...
//------------------------------------------------------------------
#define CL_MOD_DIALOG_POS
  #define CL_MOD_DIALOG_PLACE_TOP (74)
  #define CL_MOD_DIALOG_PLACE_LEFT (21)

//------------------------------------------------------------------
// タグジャンプ一覧を変更
//  - 表示するカラムの選別と並び替え 2015.8.27
//------------------------------------------------------------------
#define CL_MOD_TAGJUMP
...
//------------------------------------------------------------------
#define CL_MOD_WINLIST_POPUP
  #define CL_MOD_WINLIST_POPUP_TOP (0xffffffff)
  #define CL_MOD_WINLIST_POPUP_LEFT (0xffffffff)
  #define CL_MOD_WINLIST_POPUP_WIDTH (400)
...
//------------------------------------------------------------------
#define CL_MOD_WAITCUESOR

//------------------------------------------------------------------
// SetMainFontを修正
//  - 引数ptを追加、デフォルトを9ポイントにする 2017.3.7
//------------------------------------------------------------------
#define CL_MOD_SET_MAIN_FONT
...
//------------------------------------------------------------------
#define CL_FIX_SEARCH_KEEP_REGEXP
...
{
#endif
//- #define CL_FIX_RULER_HIDE_IGNORE_BOTTOM_SPACE
...
//------------------------------------------------------------------
#define CL_FIX_CALL_CURSOR_MOVE_UPDATEWINDOW
...
//------------------------------------------------------------------
#define CL_FIX_CURSOR_MOVE_FLICKER
