...
#define UZ_FIX_VERDLG
	#define PR_VER      2,54,0,0
	#define PR_VER_STR "2.54"
...
//------------------------------------------------------------------
// ダイアログ
//  - コンボボックスのドロップダウンは上下キーでは行えないようにする(誤操作防止) 20170704 
...
//  - 副作用で行番号が非表示のときもブックマークしているかわかるようになります
//------------------------------------------------------------------
#define UZ_FIX_BOOKMARK_DRAW_VLINE

//------------------------------------------------------------------
// 行番号縦線を行番号の色で描画する 20161221
//------------------------------------------------------------------
#define UZ_FIX_LINE_TERM_TYPE

//------------------------------------------------------------------
// 行番号背景が行番号縦線をはみ出しているのを修正 20170620 
//------------------------------------------------------------------
...
//------------------------------------------------------------------
// 大きすぎる静的バッファサイズの調整 (あまり意味はないかもしれないが…) 20170714 
//------------------------------------------------------------------
#define UZ_FIX_ADJUST_LARGE_STATIC_BUFFER_SIZE
	#define UZ_VMESSAGEBOXF_BUFF_SIZE     (2048)
	#define UZ_WRITEF_BUFF_SIZE           (2048)
	#define UZ_RECYCLEDBUFFER_CHAIN_COUNT (8)
