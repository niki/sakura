...
#define UZ_FIX_WS_COLOR
	// 空白,TAB,改行,EOF,ノート線 現在のカラーのブレンド率[%] 20150605
...
//  - アンドゥ, リドゥ用に軽量のMoveCursor(MoveCursorFastMode2)を作成 20170723 
//------------------------------------------------------------------
...
//------------------------------------------------------------------
// 行番号が非表示でブックマークが表示のときブックマークは線で描画する 20170113
//------------------------------------------------------------------
...
//------------------------------------------------------------------
// ExtTextOutによる塗りつぶしをPatBltに変更 20170708  
//------------------------------------------------------------------
