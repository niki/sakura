...
#define MI_MOD_VERDLG
  #define PR_VER      2,18,0,0
  #define PR_VER_STR "2.18"
...
#define MI_MOD_MINIMAP
  ...
  #define MI_MINIMAP_TYPE_SAKURA   (0)  // default
...
//    (REG/ReadProfilesFromRegistry:0) 0にするとレジストリから読み込まなくなります
//    (REG/WriteProfilesToRegistry:0) 0にするとレジストリに書き込まなくなります
//------------------------------------------------------------------
...
#define MI_MOD_PROFILES
  #define MI_DELETE_HISTORY_NOT_EXIST_AT_STARTUP (1)
