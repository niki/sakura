...
#define UZ_FIX_VERDLG
  #define PR_VER      2,33,0,0
  #define PR_VER_STR "2.33"
...
#define UZ_FIX_EDITVIEW_SCRBAR
  ...
  #define UZ_SCRBAR_FOUND_COLOR  _T("#0000d7")
  // ブックマークのある行の色
  // (REG/EditViewScrBarMarkColor:#d80000)
  #define UZ_SCRBAR_MARK_COLOR   _T("#d80000")
  // キャレットのある行の色
  // (REG/EditViewScrBarMarkColor:#d80000)
  #define UZ_SCRBAR_CURSOR_COLOR _T("#00d800")
...
//  ! チェック時に検索文字列を \b で囲む
//------------------------------------------------------------------
//#define UZ_FIX_ENABLE_WORD_SEARCH_REGEXP
...
//------------------------------------------------------------------
#define UZ_FIX_COLUMN_VERTICAL_LINE
