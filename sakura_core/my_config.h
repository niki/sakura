...
- [x] 2017.5.11 -> 2017.5.12
  タグファイルの作成でタグ作成フォルダの初期値を tags ファイルがあるところまで辿る
...
//  - クリックした位置が中央にするようにする 2017.5.15
//  - エリア内ドラッグでもスクロールするようにする 2017.5.15
//  - 編集ウィンドウのスクロールでミニマップのスクロールバーのスクロールもする
