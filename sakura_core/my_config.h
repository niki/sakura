...
//------------------------------------------------------------------
// 64bit版のときは 'bregonig32.dll', 'bregonig64.dll' で先に探す 2017.7.9, 
//------------------------------------------------------------------
#define UZ_BREGONIG_NAME_SEARCH

//------------------------------------------------------------------
// PPAを使用する
//  x 64bit版のときはPPAの処理を無効にする
//------------------------------------------------------------------
//#ifndef _WIN64
//#define UZ_USE_PPA
//#endif
...
//------------------------------------------------------------------
// ミニマップを使用する
//  x 実用性を感じらない最低限の実装すぎるためいっそのこと無効化する 2017.7.16, 
//------------------------------------------------------------------
//#define UZ_USE_MINIMAP

//------------------------------------------------------------------
// ウィンドウリスト一覧ダイアログを使用する
//  x 実用性を感じらない最低限の実装すぎるためいっそのこと無効化する 2017.7.16, 
//------------------------------------------------------------------
//#define UZ_USE_WINLISTDLG
...
//  - 「検索ダイアログを自動的に閉じる」を排除 2017.7.11, 
//  - 「見つからないときにメッセージを表示」を排除 2017.7.11, 
//------------------------------------------------------------------
...
//------------------------------------------------------------------
// ExtTextOutによる塗りつぶしをPatBltに変更 2017.7.8,  
//------------------------------------------------------------------
#define UZ_FIX_EXTTEXTOUT_TO_PATBLT

//------------------------------------------------------------------
// WM_ERASEBKGNDの抑制 2017.7.8, 
//------------------------------------------------------------------
#define UZ_FIX_SUPPRESSION_OF_WM_ERASEBKGND

//------------------------------------------------------------------
// タイプ設定のデフォルトを直接設定するようにする 2017.7.14,  
//  - なぜstaticで持ってコピーしているのか不明
//------------------------------------------------------------------
#define UZ_FIX_TYPE_CONFIG_DEFAULT

//------------------------------------------------------------------
// 大きすぎる静的バッファサイズの調整 (あまり意味はないかもしれないが…) 2017.7.14, 
//------------------------------------------------------------------
...
//        →水平スクロール時のみ再描画、垂直は通常動作 2017.7.10
//------------------------------------------------------------------
