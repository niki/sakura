...
// 修正者
#define NK_AUTHOR       "niki@hu-niang.com"
...
#define NK_FIX_VERDLG
	#define PR_VER      2,4205,2021,82
	#define PR_VER_STR "2.4205.2021.82"
...
#define NK_FIX_SCROLL
	...
	#define NK_HORIZONTAL_SCROLL_MARGIN (16)
	// 垂直スクロールの変更
	//  - スクロールマージンを 0 に変更 20170409
	#define NK_VERTICAL_SCROLL_MARGIN (0)
...
#define NK_FIX_TABWND
	#define NK_TABWND_FLICKER     (1)  // ウィンドウまとめモードの切り替え時にスリープを10ms入れる(ちらつき抑制) 20170406
	#define NK_TAB_CLOSE_BTN_DRAW (0)  //〆 タブを閉じるボタンをグラフィカルにする 20170423 
	#define NK_BUGFIX_TAB_EDGE    (1)  // 間に選択タブがあると右側のエッヂがないバグを修正 (となりのタブが上書き描画していた) 20170429 
...
// - Funccode_x.hsrcを修正
//------------------------------------------------------------------
#define NK_FIX_SWITCH_DISP_LINENR_MACRO

//------------------------------------------------------------------
// カーソル行アンダーライン
//  - 行番号を含む左端から 20150130
//------------------------------------------------------------------
#define NK_FIX_CUR_UNDERLINE
...
//------------------------------------------------------------------
#define NK_FIX_BREGONIG_NAME_SEARCH
...
//------------------------------------------------------------------
#define NK_FIX_MULTIPLE_OPEN_FILES
