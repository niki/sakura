...
//------------------------------------------------------------------
#define SC_MOD_VERDLG
  #define PR_VER      2,21,0,0
  #define PR_VER_STR "2.21"
...
//------------------------------------------------------------------
#define SC_MOD_CENTERING_CURSOR_JUMP
...
//------------------------------------------------------------------
#define SC_MOD_CHANGE_TAB_WIDTH_MACRO
...
//  - .rcファイルは数が多いので置換対応
//------------------------------------------------------------------
#define SC_MOD_UI_FONT

//------------------------------------------------------------------
// 'BOM付' を 'BOM' に変更 2017.4.17
//  - わざわざ「付」をつけなくても認識できると判断とスペースの節約
//------------------------------------------------------------------
#define SC_MOD_WITH_BOM_TEXT

//------------------------------------------------------------------
// タブ名カラー
//------------------------------------------------------------------
#define SC_MOD_TAB_CAPTION_COLOR
  // 変更ドキュメントタブ名カラー
...
//------------------------------------------------------------------
#define SC_MOD_TAB_MARK

//------------------------------------------------------------------
// カーソル行アンダーライン
//  - 左端から 2015.1.30
//------------------------------------------------------------------
#define SC_MOD_CUR_UL
...
//  - 折り返し記号 テキストカラーのみ
//------------------------------------------------------------------
#define SC_MOD_COLOR_STRATEGY

//------------------------------------------------------------------
// コメント行 2016.12.27
// 0x01: 改行以降もカラーを有効にする (Imitate 'Sublime Text')
//------------------------------------------------------------------
#define SC_MOD_COMMENT

//------------------------------------------------------------------
// 数値の色付け判定
//  - 正規表現で判定する 2017.4.21
//------------------------------------------------------------------
#define SC_MOD_NUMERIC_COLOR
...
//------------------------------------------------------------------
#define SC_MOD_MAINMENU_FORCE_DEFAULT
...
//------------------------------------------------------------------
#define SC_MOD_SEARCH_KEY_REGEXP_AUTO_QUOTE

//------------------------------------------------------------------
// 正規表現検索のときに「単語単位で探す」を使用できるようにする 2017.4.27
//  ! チェック時に検索文字列を \b で囲む
//------------------------------------------------------------------
//#define SC_MOD_ENABLE_WORD_SEARCH_REGEXP
...
//------------------------------------------------------------------
#define SC_MOD_TAGJUMP

//------------------------------------------------------------------
// タグファイル作成ダイアログ
//  - タグ作成フォルダの初期値を tags ファイルがあるところまで辿る 2017.5.12
//------------------------------------------------------------------
#define SC_MOD_TAGMAKEDLG
...
//------------------------------------------------------------------
#define SC_FIX_MINIMAP_NOFOCUS

//------------------------------------------------------------------
// ルールファイル解析で「デフォルト」だとソートしていないため逆順になる 2017.5.9
//------------------------------------------------------------------
#define SC_FIX_FUNCLIST_RULEFILE
...
//------------------------------------------------------------------
#define SC_FIX_CALL_CURSOR_MOVE_UPDATEWINDOW
...
//------------------------------------------------------------------
#define SC_FIX_CURSOR_MOVE_FLICKER
